...
class ImgOptimize extends Command
{
     ...
     * @var string
     */
    protected $description = 'Image Optimize';
    ...
    public function handle()
    {
        ...
        $this->info('Optimized 👏');
        $this->info('Converting image to webp... ☕☕☕');
        $convertWebp = $dirname.'/'.$filename.'.webp';
        passthru("convert $path $convertWebp");
        $this->info('Convert Succesful 👏');
    }
}
