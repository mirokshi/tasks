<template>
    <div class="container flex justify-center">
        ...
        <button @click="add"> <svg class="h-5 w-4.5 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M11 9h4v2h-4v4H9v-4H5V9h4V5h2v4zm-1 11a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16z"/></svg></button>
            </div>
        <!--SINTAX SUGAR-->
        ...
        <ul class="list-reset">
            ...
            <li v-for="task in filteredTask" :key="tasks.id" class="text-grey-darker m-2 pl-5"
            ...
            <ul class="list-reset">
                <li><button @click="setFilter('All')">Todos</button></li>
                <li><button @click="setFilter('Completed')">Completados</button></li>
                <li><button @click="setFilter('Active')">Pendientes</button></li>
            </ul>
        </div>
